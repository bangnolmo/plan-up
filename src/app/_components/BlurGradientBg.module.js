...
function e(t, e, i) {
    return (e = a(e)), u(t, o() ? Reflect.construct(e, i || [], a(t).constructor) : e.apply(t, i));
}
function i(t, e) {
...
function n(t, e, i) {
    return e && r(t.prototype, e), i && r(t, i), Object.defineProperty(t, "prototype", { writable: !1 }), t;
}
function s() {
    return (
        (s =
            ...
            n(r, [
                ...
                },
                {
                    ...
                    value: function (t) {
                        ...
                        return (
                            t.length
                                ? ((i = this), (r = t), ((e = this)[0] = i[0] * r[0]), (e[1] = i[1] * r[1]), (e[2] = i[2] * r[2]))
                                : b(this, this, t),
                            this
                        );
                    },
                ...
                },
                {
                    ...
                    value: function (t) {
                        return t
                            ? ((e = this), (r = (i = t)[0] - e[0]), (n = i[1] - e[1]), (s = i[2] - e[2]), Math.sqrt(r * r + n * n + s * s))
                            : p(this);
                        var e, i, r, n, s;
                    },
                },
                ...
                },
                {
                    key: "squaredDistance",
                    value: function (t) {
                        return t ? ((e = this), (r = (i = t)[0] - e[0]), (n = i[1] - e[1]), (s = i[2] - e[2]), r * r + n * n + s * s) : x(this);
                        var e, i, r, n, s;
                    },
                },
                {
                        ...
                        (null === (e = this.attributes.index) || void 0 === e ? void 0 : e.type) === this.gl.UNSIGNED_INT && (a = 4),
                            this.isInstanced
                                ? this.attributes.index
                                    ...
                                    : this.gl.renderer.drawArraysInstanced(s, this.drawRange.start, this.drawRange.count, this.instancedCount)
                                : this.attributes.index
                ...
                },
                {
                    ...
                    value: function (t) {
                        ...
                        for (var r = 0, n = 0, s = e.length; n < s; n += i)
                            F.fromArray(e, n), (r = Math.max(r, this.bounds.center.squaredDistance(F)));
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        this.gl.renderer.state.currentProgram === this.id ||
                            (this.gl.useProgram(this.program), (this.gl.renderer.state.currentProgram = this.id)),
                            this.uniformLocations.forEach(function (e, i) {
                                ...
                                if (!s) return L("Active uniform ".concat(i.name, " has not been supplied"));
                                if (s && void 0 === s.value) return L("".concat(i.name, " uniform is missing a value parameter"));
                                if (s.value.texture) return (r += 1), s.value.update(r), U(t.gl, i.type, e, r);
...
function U(t, e, i, r) {
    ...
    if (r.length)
        if (void 0 === n || n.length !== r.length) t.renderer.state.uniformLocations.set(i, r.slice(0));
        else {
            if (
                (function (t, e) {
        ...
        return n(
            function t() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    ...
                    R = void 0 === T ? 2 : T;
                i(this, t);
                var F = { alpha: f, depth: g, stencil: p, antialias: y, premultipliedAlpha: b, preserveDrawingBuffer: E, powerPreference: M };
                (this.dpr = l),
                    (this.alpha = f),
                    (this.color = !0),
                    (this.depth = g),
                            ...
                            s.forEach(function (t) {
                                t.program.transparent ? (t.program.depthTest ? h.push(t) : o.push(t)) : a.push(t),
                                    ...
                                    0 === t.renderOrder &&
                                        t.program.depthTest &&
                                        i &&
                                        (t.worldMatrix.getTranslation(z), z.applyMatrix4(i.projectionViewMatrix), (t.zDepth = z.z));
                            }),
                    ...
                    value: function (t) {
                        ...
                        null === n
                            ...
                            (c || (this.autoClear && !1 !== c)) &&
                                (!this.depth || (n && !n.depth) || (this.enable(this.gl.DEPTH_TEST), this.setDepthMask(!0)),
                                this.gl.clear(
                            ...
                            this.getRenderList({ scene: e, camera: i, frustumCull: l, sort: o }).forEach(function (t) {
                                t.draw({ camera: i });
                            });
                    },
                },
...
var X = function (t, e) {
    ...
    Y = (function (t) {
        function r() {
            ...
            i(this, r), ((t = e(this, r, [n, s, a, h])).onChange = function () {}), (t._target = t);
            var o = ["0", "1", "2", "3"];
            return u(
                t,
                new Proxy(t, {
        ...
        return (
            ...
            n(r, [
                ...
                },
                {
                    key: "set",
                    value: function (t, e, i, r) {
                        return t.length ? this.copy(t) : (V(this._target, t, e, i, r), this.onChange(), this);
                    },
                },
                {
                    key: "rotateX",
                ...
                },
                {
                    ...
                    value: function () {
                        var t,
                            e,
                            i = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this._target;
                ...
                },
                {
                    key: "multiply",
                    value: function (t, e) {
                        return e ? G(this._target, t, e) : G(this._target, this._target, t), this.onChange(), this;
                    },
                },
                {
                    key: "dot",
                        ...
                        return (
                            (function (t, e, i, r) {
                                var n,
                                    ...
                                    v = i[2],
                                    p = i[3];
                                (s = u * d + l * g + c * v + f * p) < 0 && ((s = -s), (d = -d), (g = -g), (v = -v), (p = -p)),
                                    1 - s > 1e-6
                                        ? ((n = Math.acos(s)), (a = Math.sin(n)), (h = Math.sin((1 - r) * n) / a), (o = Math.sin(r * n) / a))
                                        : ((h = 1 - r), (o = r)),
                                    (t[0] = h * u + o * d),
                                    (t[1] = h * l + o * g),
                                    (t[2] = h * c + o * v),
...
var $,
    J =
        ...
        function (t, e) {
            ...
            return (
                v > 0
                    ? ((p = 2 * Math.sqrt(v + 1)), (t[3] = 0.25 * p), (t[0] = (c - d) / p), (t[1] = (f - o) / p), (t[2] = (h - u) / p))
                    : a > l && a > g
                      ? ((p = 2 * Math.sqrt(1 + a - l - g)), (t[3] = (c - d) / p), (t[0] = 0.25 * p), (t[1] = (h + u) / p), (t[2] = (f + o) / p))
                      : l > g
                        ? ((p = 2 * Math.sqrt(1 + l - a - g)), (t[3] = (f - o) / p), (t[0] = (h + u) / p), (t[1] = 0.25 * p), (t[2] = (c + d) / p))
                        : ((p = 2 * Math.sqrt(1 + g - a - l)), (t[3] = (h - u) / p), (t[0] = (f + o) / p), (t[1] = (c + d) / p), (t[2] = 0.25 * p)),
                t
            );
        });
function tt(t, e, i) {
...
var it = (function (t) {
    function r() {
        ...
        return i(this, r), u((t = e(this, r, [n, s, a, h, o, l, c, f, d, g, v, p, m, y, _, b])), t);
    }
    return (
        h(r, v(Array)),
        n(r, [
                    ...
                    return (
                        (function (t, e, i, r) {
                            var n = p([t[0], t[1], t[2]]),
                                s = p([t[4], t[5], t[6]]),
                                a = p([t[8], t[9], t[10]]);
                            Z(t) < 0 && (n = -n), (i[0] = t[12]), (i[1] = t[13]), (i[2] = t[14]);
                            var h = t.slice(),
                                o = 1 / n,
                                u = 1 / s,
                                l = 1 / a;
                    ...
                    return (
                        (function (t, e, i, r) {
                            var n = e[0],
                                ...
                                f = a - i[2],
                                d = l * l + c * c + f * f;
                            0 === d ? (f = 1) : ((l *= d = 1 / Math.sqrt(d)), (c *= d), (f *= d));
                            var g = o * f - u * c,
                                v = u * l - h * f,
                                p = h * c - o * l;
                            0 == (d = g * g + v * v + p * p) &&
...
var rt = new it(),
    nt = (function (t) {
        function r() {
            ...
            i(this, r), ((t = e(this, r, [n, s, a])).order = h), (t.onChange = function () {}), (t._target = t);
            var o = ["0", "1", "2"];
            return u(
                t,
                new Proxy(t, {
            ...
            n(r, [
                ...
                },
                {
                    ...
                    value: function (t) {
                        ...
                        return rt.fromQuaternion(t), this._target.fromRotationMatrix(rt, e), i || this.onChange(), this;
                    },
                },
                {
                    key: "fromArray",
    ...
    ut = (function (t) {
        function r(t) {
            ...
            return (
                i(this, r),
                (n = e(this, r)),
                Object.assign(n, { near: h, far: u, fov: c, aspect: d, left: g, right: v, bottom: p, top: m, zoom: _ }),
            ...
            n(r, [
                {
                    ...
                    value: function () {
                        ...
                        return (
                            ...
                            this.projectionMatrix.fromPerspective({ fov: a * (Math.PI / 180), aspect: o, near: i, far: n }),
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        return (
                            Object.assign(this, { near: i, far: n, left: a, right: o, bottom: l, top: f, zoom: g }),
                            (a /= g),
                            (o /= g),
                            (l /= g),
                            (f /= g),
                            this.projectionMatrix.fromOrthogonal({ left: a, right: o, bottom: l, top: f, near: i, far: n }),
                ...
                },
                {
                    key: "unproject",
                    value: function (t) {
                        return t.applyMatrix4(at.inverse(this.projectionMatrix)), t.applyMatrix4(this.worldMatrix), this;
                    },
                },
                {
                    key: "updateFrustum",
            ...
            n(r, [
                ...
                },
                {
                    ...
                    value: function () {
                        var t;
                        return (
                            ((t = this)[0] = 1), (t[1] = 0), (t[2] = 0), (t[3] = 0), (t[4] = 1), (t[5] = 0), (t[6] = 0), (t[7] = 0), (t[8] = 1), this
                        );
                    },
                },
                {
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        return (
                            ...
                            (u = e[7]),
                            (l = e[8]),
                            (g = i * (c = l * a - h * u) + r * (f = -l * s + h * o) + n * (d = u * s - a * o)) &&
                                ((g = 1 / g),
                                (t[0] = c * g),
                                (t[1] = (-l * r + n * u) * g),
                                (t[2] = (h * r - n * a) * g),
                        ...
                        if (((e || this.glState.textureUnits[t] !== this.id) && (this.gl.renderer.activeTexture(t), this.bind()), e)) {
                            if (
                                ...
                                this.flipY !== this.glState.flipY &&
                                    (this.gl.pixelStorei(this.gl.UNPACK_FLIP_Y_WEBGL, this.flipY), (this.glState.flipY = this.flipY)),
                                ...
                                this.wrapS !== this.state.wrapS &&
                                    (this.gl.texParameteri(this.target, this.gl.TEXTURE_WRAP_S, this.wrapS), (this.state.wrapS = this.wrapS)),
                                this.wrapT !== this.state.wrapT &&
                                    (this.gl.texParameteri(this.target, this.gl.TEXTURE_WRAP_T, this.wrapT), (this.state.wrapT = this.wrapT)),
                                this.anisotropy &&
                                ...
                                this.generateMipmaps &&
                                    (this.gl.renderer.isWebgl2 || (vt(this.image.width) && vt(this.image.height))
                                ...
                                this.width
                                    ...
                                    : this.gl.texImage2D(this.target, 0, this.gl.RGBA, 1, 1, 0, this.gl.RGBA, this.gl.UNSIGNED_BYTE, gt);
        ...
        return n(
            function t(e) {
                ...
                B.length > 1 && this.gl.renderer.drawBuffers(B),
                    ...
                    m && (this.gl.renderer.isWebgl2 || this.gl.renderer.getExtension("WEBGL_depth_texture"))
...
var wt = Object.freeze({ __proto__: null, hexToRGB: bt, numberToRGB: xt, parseColor: Et }),
    Mt = (function (t) {
        function r(t) {
            var n;
            return i(this, r), Array.isArray(t) ? u(n, (n = e(this, r, c(t)))) : u(n, (n = e(this, r, c(Et.apply(wt, arguments)))));
        }
        return (
            h(r, v(Array)),
            n(r, [
        ...
        return (
            ...
            n(r, [
                ...
                },
                {
                    ...
                    value: function (t) {
                        var e, i, r;
                        return t.length ? ((i = this), (r = t), ((e = this)[0] = i[0] * r[0]), (e[1] = i[1] * r[1])) : Tt(this, this, t), this;
                    },
                },
                {
                    key: "divide",
                    value: function (t) {
                        var e, i, r;
                        return t.length ? ((i = this), (r = t), ((e = this)[0] = i[0] / r[0]), (e[1] = i[1] / r[1])) : Tt(this, this, 1 / t), this;
                    },
                },
                {
                    key: "inverse",
                ...
                },
                {
                    key: "distance",
                    value: function (t) {
                        return t ? ((e = this), (r = (i = t)[0] - e[0]), (n = i[1] - e[1]), Math.sqrt(r * r + n * n)) : Rt(this);
                        var e, i, r, n;
                    },
                },
                {
                ...
                },
                {
                    ...
                    value: function (t) {
                        return t
                            ? ((e = this), (r = (i = t)[0] - e[0]), (n = i[1] - e[1]), r * r + n * n)
                            : (function (t) {
                                  var e = t[0],
                                      i = t[1];
                                  return e * e + i * i;
                ...
                },
                {
                    ...
                    value: function () {
                        var t, e;
                        return (
                            (e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this), ((t = this)[0] = -e[0]), (t[1] = -e[1]), this
                        );
                    },
                },
                {
    ...
    Ct = (function (t) {
        function r(t) {
            ...
            return (
                ...
                Object.assign(g, { position: { size: 3, data: _ }, normal: { size: 3, data: b }, uv: { size: 2, data: x }, index: { data: E } }),
                e(this, r, [t, g])
            );
        }
        return (
                    ...
                    value: function (t, e, i, r, n, s, a, h, o) {
                        for (
                            var u = arguments.length > 9 && void 0 !== arguments[9] ? arguments[9] : 0,
                                ...
                                c = arguments.length > 11 && void 0 !== arguments[11] ? arguments[11] : 2,
                                f = arguments.length > 12 && void 0 !== arguments[12] ? arguments[12] : 1,
                                d = arguments.length > 13 && void 0 !== arguments[13] ? arguments[13] : -1,
                                g = arguments.length > 14 && void 0 !== arguments[14] ? arguments[14] : 0,
                                v = arguments.length > 15 && void 0 !== arguments[15] ? arguments[15] : 0,
                                p = g,
                                m = n / h,
                                y = s / o,
                                _ = 0;
...
!(function () {
    !(function (t, e, i) {
                              ...
                              ? (function () {
                                    try {
                                        ...
                                        return (
                                            r && (i = r.randomBytes)
                                                ? (i = i(n))
                                                : ((i = new Uint8Array(n)), (t.crypto || t.msCrypto).getRandomValues(i)),
                                            p(i)
                                        );
                                    } catch (i) {
                                        var s = t.navigator,
        ...
        function c(t) {
            ...
            (r.g = function (t) {
                for (var e, i = 0, s = r.i, a = r.j, h = r.S; t--; )
                    (e = h[(s = u & (s + 1))]), (i = i * n + h[u & ((h[s] = h[(a = u & (a + e))]) + (h[a] = e))]);
        ...
        if ((v(i.random(), e), "object" == ("undefined" == typeof module ? "undefined" : d(module)) && module.exports)) {
            module.exports = l;
            try {
                r = require("crypto");
            } catch (t) {}
...
var Pt = (function () {
                ...
                i(this, t),
                    ...
                    (n = function () {
                        requestAnimationFrame(s._update),
                            ...
                            s.isRenderTarget &&
                                (s.gl.clearColor(0, 0, 0, 1), s.renderer.render({ scene: s.rttPlane, camera: s.rttCamera, target: s.rtt }));
                    }),
                    (r = f((r = "_update"))) in e
                    ...
                    (this.frame = 0),
                    (this.parentDom = a.dom ? document.getElementById(a.dom) : document.body),
            ...
            [
                ...
                },
                {
                    ...
                    value: function (t) {
                        ...
                        if (((this.palette = []), 0 == t.length)) this.palette = ["#F00911", "#F3AA00", "#F6EE0B", "#39E90D", "#195ED2", "#F00911"];
    ...
    Ot = (function (t) {
        function r() {
            ...
            return i(this, r), ((t = e(this, r, [n, 4])).name = "blur-gradient"), t.start(), t;
        }
        return (
            h(r, Pt),
            n(r, [
                {
                    ...
                    value: function () {
                        (this.rtt = new yt(this.gl, { width: 512, height: 512 })),
                            (this.rttCamera = new ut(this.gl, { left: -0.5, right: 0.5, bottom: -0.5, top: 0.5, zoom: 1 })),
                            ...
                            (this.rttProgram = new D(this.gl, {
                                ...
                                uniforms: {
                                    u_time: { value: 0 },
                                    u_resolution: { value: new St(2 * this.canvasW, 2 * this.canvasH) },
                            ...
                            (this.rttPlane = new dt(this.gl, { geometry: this.rttPlaneGeo, program: this.rttProgram })),
                ...
                },
                {
                    ...
                    value: function () {
                        this._planeShader = new D(this.gl, {
                            ...
                            uniforms: { tMap: { value: this.rtt.texture }, uNoiseFactor: { value: 0.1 }, uTime: { value: 0 } },
                        });
                    },
                },
                {
                    key: "_make",
                    value: function () {
                        var t = new Ct(this.gl, { width: this.canvasW, height: this.canvasH });
                        new dt(this.gl, { geometry: t, program: this._planeShader }).setParent(this.scene);
                    },
                },
                {
                    key: "_resetColors",
                ...
                },
                {
                    key: "update",
                    value: function (t, e) {
                        if ("noise" === t) this._planeShader.uniforms.uNoiseFactor.value = parseFloat(e);
                    },
                },
            ])
        );
